...
namespace CinemaTicketBooking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260523223012_AddCustomerDateOfBirthAndGender")]
    partial class AddCustomerDateOfBirthAndGender
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.BookingConcession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.Cinema", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.Concession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.LoyaltyTierConfiguration", b =>
                {
                    ...
                    b.ToTable("loyalty_tier_configurations", (string)null);
                });

            modelBuilder.Entity("CinemaTicketBooking.Domain.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.PricingPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.SeatSelectionPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Infrastructure.Auth.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Infrastructure.Auth.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Infrastructure.Auth.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.Booking", b =>
                {
                    b.HasOne("CinemaTicketBooking.Domain.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("CinemaTicketBooking.Domain.ShowTime", "ShowTime")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.BookingConcession", b =>
                {
                    ...
                    b.HasOne("CinemaTicketBooking.Domain.Concession", "Concession")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.BookingTicket", b =>
                {
                    ...
                    b.HasOne("CinemaTicketBooking.Domain.Ticket", "Ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.PaymentTransaction", b =>
                {
                    b.HasOne("CinemaTicketBooking.Domain.Booking", "Booking")
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.PricingPolicy", b =>
                {
                    b.HasOne("CinemaTicketBooking.Domain.Cinema", "Cinema")
                        .WithMany()
            ...
            modelBuilder.Entity("CinemaTicketBooking.Domain.ShowTime", b =>
                {
                    b.HasOne("CinemaTicketBooking.Domain.Movie", "Movie")
                        .WithMany()
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CinemaTicketBooking.Domain.Screen", "Screen")
                        .WithMany()
                        .HasForeignKey("ScreenId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CinemaTicketBooking.Infrastructure.Auth.RefreshToken", b =>
                {
                    b.HasOne("CinemaTicketBooking.Infrastructure.Auth.Account", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("CinemaTicketBooking.Infrastructure.Auth.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CinemaTicketBooking.Infrastructure.Auth.Account", null)
                        .WithMany()
